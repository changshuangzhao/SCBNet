...
import skimage
from dataloader import KITTI_submission_loader2015 as DA
import numpy as np
...
parser.add_argument('--datapath', default='../dataset/kitti_2015/testing/',
                    help='select model')
parser.add_argument('--loadmodel', default='./results/Kitti_2015/finetune_checkpoint_293.pth',
                    help='loading model')
...
def main():
    ...
    for inx in range(len(test_left_img)):
        ...
        skimage.io.imsave('./results/Kitti_2015/submission_disp/disp_0/' + test_left_img[inx].split('/')[-1], (img * 256).astype('uint16'))
